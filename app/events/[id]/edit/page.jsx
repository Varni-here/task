    ...
    try {
      ...
      if (data.success) {
        ...
        setFormData({
          ...
          recurringEndDate: event.recurringEndDate ? new Date(event.recurringEndDate).toISOString().slice(0, 10) : "",
        });
      } else {
        router.push("/events");
      }
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="text-center sm:text-left">
              <h1 className="text-2xl sm:text-4xl font-bold text-gray-800 mb-2">Edit Event</h1>
              <p className="text-gray-600 text-sm sm:text-base">Update your event details</p>
            </div>
            <Link
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 text-blue-600 border-2 border-gray-300 rounded focus:ring-blue-500 mr-3"
                />
                <div>
                  <span className="text-lg font-semibold text-gray-800">Recurring Event</span>
                  <p className="text-gray-600 text-sm">Make this event repeat on a schedule</p>
                </div>
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 font-semibold text-lg shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
